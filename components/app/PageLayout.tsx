...
const CONTENT_CLASS = "mx-auto w-full max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl px-4 pt-[max(1.5rem,env(safe-area-inset-top))] pb-6 md:pb-8 min-h-0 flex-1 flex flex-col md:min-h-[calc(100vh-1px)]";
const MESSAGES_LIST_CLASS = "w-full px-4 pt-[max(1.5rem,env(safe-area-inset-top))] pb-6 md:pb-8 min-h-0 flex-1 flex flex-col md:min-h-[calc(100vh-1px)] md:mx-auto md:max-w-2xl lg:max-w-3xl xl:max-w-4xl";
